...
const vec2 kSimulation_EnemyAircraft_RayGun_Live_BaseSize     = vec2(1.20f, 1.20f);
const vec2 kSimulation_EnemyAircraft_RayGun_Live_BaseVelocity = vec2(0.00f, -0.03f);
