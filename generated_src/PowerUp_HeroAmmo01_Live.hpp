...
const vec2 kSimulation_PowerUp_HeroAmmo01_Live_BaseSize     = vec2(0.6000f, 0.6000f);
const vec2 kSimulation_PowerUp_HeroAmmo01_Live_BaseVelocity = vec2(0.0000f, -0.0500f);
...
extern vec2  g_Simulation_PowerUp_HeroAmmo01_Live_Vel[kSimulation_PowerUp_HeroAmmo01_Live_MaxCount];
