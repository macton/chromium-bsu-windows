...
if (process.argv.length < 4) {
  console.error( process.argv[1] + ' [config.yml] [bsu_schema.yml]' );
  process.exit(1);
}
...
const config_filename_in_extname   = path.extname( config_filename_in );
const config_filename_in_basename  = path.basename( config_filename_in, config_filename_in_extname );
const config_filename_in_dirname   = path.dirname( config_filename_in );
const bsu_filename_out             = path.resolve( config_filename_in_dirname, config_filename_in_basename + ".bsu" );
