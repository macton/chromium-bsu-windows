...
// Write Buffer
#include "Simulation_EnemyAircraft_Omni_live.hpp"

int    g_Simulation_EnemyAircraft_Omni_Live_Count;
vec2   g_Simulation_EnemyAircraft_Omni_Live_Pos[kSimulation_EnemyAircraft_Omni_Live_MaxCount];
float  g_Simulation_EnemyAircraft_Omni_Live_Age[kSimulation_EnemyAircraft_Omni_Live_MaxCount];
float  g_Simulation_EnemyAircraft_Omni_NextSpawnTime;

void
Simulation_EnemyAircraft_Omni_Live_Reset()
{
  g_Simulation_EnemyAircraft_Omni_Live_Count    = 0;
  g_Simulation_EnemyAircraft_Omni_NextSpawnTime = 0.0f;
}

void
Simulation_EnemyAircraft_Omni_Live_CreateNew_Level_0()
{
  // Read Buffers
  ...
  // Write Buffer
  float           next_spawn_time         = g_Simulation_EnemyAircraft_Omni_NextSpawnTime;
  int             live_count              = g_Simulation_EnemyAircraft_Omni_Live_Count;
  vec2*           live_pos                = g_Simulation_EnemyAircraft_Omni_Live_Pos;
  float*          live_age                = g_Simulation_EnemyAircraft_Omni_Live_Age;
  ...
  g_Simulation_EnemyAircraft_Omni_Live_Count    = live_count;
  g_Simulation_EnemyAircraft_Omni_NextSpawnTime = time + time_step;
}



void
Simulation_EnemyAircraft_Omni_Live_CreateNew()
{
  // Read Buffers
  ...
  switch (level)
  {
    ...
    case 0: Simulation_EnemyAircraft_Omni_Live_CreateNew_Level_0(); break;
    
  }
}

void
Simulation_EnemyAircraft_Omni_Live_UpdateExisting()
{
  // Read Buffers
  const vec2   simulation_rect         = kSimulation_PlayArea;
  const float  simulation_rect_left    = -simulation_rect.x;
