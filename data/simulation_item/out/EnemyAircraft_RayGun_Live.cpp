...
// Write Buffer
#include "Simulation_EnemyAircraft_RayGun_live.hpp"

int    g_Simulation_EnemyAircraft_RayGun_Live_Count;
vec2   g_Simulation_EnemyAircraft_RayGun_Live_Pos[kSimulation_EnemyAircraft_RayGun_Live_MaxCount];
float  g_Simulation_EnemyAircraft_RayGun_Live_Age[kSimulation_EnemyAircraft_RayGun_Live_MaxCount];
float  g_Simulation_EnemyAircraft_RayGun_NextSpawnTime;

void
Simulation_EnemyAircraft_RayGun_Live_Reset()
{
  g_Simulation_EnemyAircraft_RayGun_Live_Count    = 0;
  g_Simulation_EnemyAircraft_RayGun_NextSpawnTime = 0.0f;
}
...
void
Simulation_EnemyAircraft_RayGun_Live_CreateNew()
{
  // Read Buffers
...
void
Simulation_EnemyAircraft_RayGun_Live_UpdateExisting()
{
  // Read Buffers
  ...
  float*       live_age                = g_Simulation_EnemyAircraft_RayGun_Live_Age;
